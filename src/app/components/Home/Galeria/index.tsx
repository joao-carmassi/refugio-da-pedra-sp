function Galeria() {
  return (
    <section className="flex flex-col px-4 lg:px-28 items-center gap-5">
      <h2 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
        Nossa pousada:
      </h2>
      <p className="md:my-3 px-4 text-center lg:w-1/2 text-lg text-gray-800 dark:text-neutral-400">
