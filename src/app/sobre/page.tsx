      ...
      <section className='container space-y-6 md:space-y-8 max-w-3xl'>
        ...
        <div className='prose dark:prose-invert max-w-none space-y-4 text-muted-foreground leading-relaxed'>
          <p>
            ...
            centenárias e o cheiro de eucalipto molhado, que decidimos trocar
            a rotina da cidade grande por um pedaço de terra na Mantiqueira e
            construir, aos poucos, os primeiros chalés.
          </p>
          <p>
            Não somos uma rede de hotéis, nem um empreendimento gerido à
            distância. Somos uma família que mora perto, que cuida do jardim
            no fim de semana, que conhece cada chalé pelo nome e sabe qual
            deles pega o melhor sol da manhã. Cada detalhe da hospedagem — da
            lenha separada para a lareira ao horário do café — passa pelas
            nossas mãos, porque acreditamos que hospitalidade de verdade não
            se terceiriza.
          </p>
          <p>
            Quem chega ao Refúgio da Pedra costuma dizer a mesma coisa: o
            silêncio impressiona. Aqui, os dias começam com o vapor subindo
            do vale e terminam com o céu mais estrelado do que a maioria das
            pessoas já viu. Entre uma coisa e outra, dá tempo de caminhar até
            a cachoeira, ler um livro na varanda ou simplesmente não fazer
            nada — o que, na correria do dia a dia, virou um luxo raro.
          </p>
          <p>
          ...
          <p>
            ...
            atendimento padronizado de central telefônica. Vai falar
            diretamente com quem cuida do lugar, tirar dúvidas pelo WhatsApp e
            ser recebido por gente que gosta genuinamente de receber. É assim
            que gostaríamos de ser recebidos também — e é esse o Refúgio da
            Pedra que convidamos você a conhecer.
          </p>
        </div>
      </section>
    </main>
