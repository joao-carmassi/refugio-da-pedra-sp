...
export const PERGUNTAS: Pergunta[] = [
  ...
  },
  {
    ...
    resposta:
      'Do centro de São Bento do Sapucaí, na praça da matriz — o lugar de onde qualquer morador diria que se sai. Medir tudo do mesmo ponto deixa os números comparáveis entre si, e a conta é por estrada, não em linha reta. A Cachoeira do Encontro fica a 7,6 km do centro, e o Refúgio da Pedra SP, a pousada que mantém este mapa, a 10 km. No Complexo da Pedra do Baú o número é o do estacionamento onde a trilha começa, e são dois: o cume do Baú, a Pedra Ana Chata e o Campo Escola sobem pelo estacionamento do Chico Bento, a 8,3 km, e o Bauzinho e a rampa de voo livre entram pela portaria do Monumento Natural, a 22,4 km, do outro lado do maciço. Onde o carro não chega ao ponto, a ficha diz onde ele para e quanto sobra de caminhada. Quem se hospeda no Refúgio abre o mapa por um link próprio, que refaz todas as contas a partir da pousada.',
  },
];
