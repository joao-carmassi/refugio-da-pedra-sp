...
/**
 * Corpo client da listagem de chalés (tooltips e reveal). O `page.tsx` ao lado
 * é server component e cuida só do JSON-LD da rota.
 */
function Catalogo(): React.ReactNode {
